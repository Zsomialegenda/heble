...
| `/delete/:id?`                  | DELETE      | Felhasználók törlése (rendes és admin felhasználók). | 200 OK - Sikeres törlés <br/> 401 Unauthorized - Token szükséges <br/> 400 Bad request - Hiányzó adatok <br/> 404 Not Found - Felhasználó nem található <br/> 401 Unathorized - Érvénytelen token <br/> 500 Internal Server Error - Sikertelen törlés |
